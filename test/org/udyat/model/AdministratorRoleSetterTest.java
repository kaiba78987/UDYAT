...
/** This is a test for AdministratorRoleSetter class
 * @author Estrada Martínez, F.J.
 *
 */
public class AdministratorRoleSetterTest {
	private User user;
	...
	public void testSetRole () throws UserRoleException {
		...
		assertTrue(user.getManagedProjects().contains(project));
		assertTrue(project.getAdministrators().contains(user));
	}
